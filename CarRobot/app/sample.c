...
int sample_z_process_command_call(char* ptag, char* pval)
{
    ...
    else if (memcmp(ptag, "CD1", 3) == 0) {                     //设置D1
        int value = atoi(pval);
        if (value > 0) {
            D1 &= ~value;
        }
    }
    else if (memcmp(ptag, "OD1", 3) == 0) {                     //设置D1
        int value = atoi(pval);
        if (value > 0) {
            D1 |= value;
        }
    }
    else if (memcmp(ptag, "CD2", 3) == 0) {                     //设置D2
        int value = atoi(pval);
        if (value > 0) {
            D2 &= ~value;
        }
    }
    else if (memcmp(ptag, "OD2", 3) == 0) {                     //设置D2
        int value = atoi(pval);
        if (value > 0) {
            D2 |= value;
        }
    ...
    else if(memcmp(ptag, "D2", 2) == 0)
    {
        ...
        {            
            ...
            {
                D2 = value;
                process_post(&user, d2Recv_event, &D2);
            }
        }
    }
