...
PD12 -- RS // lcd  A17
#if ST7789
PG2 --- RS // A12  //2.4寸小屏用 or  PD13 --- A18
#endif
...
void fsmc_init(void)
{
    ...
    RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOD|RCC_AHB1Periph_GPIOE|RCC_AHB1Periph_GPIOG, ENABLE);//使能GPIO时钟
...
#if ST7789
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_13;                   //选中相应的引脚
    GPIO_Init(GPIOD, &GPIO_InitStructure);
    
    GPIO_PinAFConfig(GPIOD,GPIO_PinSource13,GPIO_AF_FSMC);
#else
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_12;                   //选中相应的引脚
    GPIO_Init(GPIOD, &GPIO_InitStructure);
